...
export default function Home() {
  ...
  return (
    <div
      className="min-h-screen home-page"
      style={{ fontFamily: "'Karla', sans-serif", background: bg, color: "#c0c8e0" }}
    >
      <style>{`
      ...
      <header className="px-6 md:px-10 py-6 flex items-center justify-between">
        <span
          ...
          style={{ fontFamily: "'Outfit', sans-serif", color: accent, letterSpacing: "-0.03em" }}
        >
          PayBack
        </span>
        <PrimaryCta
      ...
      <section className="px-6 md:px-10 py-16 md:py-24">
        <div className="grid md:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
          <div>
            <h1
              className="text-4xl md:text-6xl font-bold leading-[0.95] mb-6"
            ...
            <p className="text-base max-w-md mb-8" style={{ color: muted }}>
              Stop chasing people for money. PayBack tracks every shared expense so you can focus on
              making memories, not spreadsheets.
            </p>
            <PrimaryCta
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              ...
              >
                ...
                <p
                  ...
                  style={{ fontFamily: "'Outfit', sans-serif", color: pink }}
                >
                  $144.98
                </p>
              </div>
      ...
      <section className="px-6 py-14 text-center">
        ...
        >
          <p
            ...
            style={{ fontFamily: "'Outfit', sans-serif" }}
          >
            Free forever <span style={{ color: accent }}>•</span> No ads{" "}
            <span style={{ color: accent }}>•</span> No catch
          </p>
