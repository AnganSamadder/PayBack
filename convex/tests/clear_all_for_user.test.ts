  ...
  test("expenses.clearAllForUser removes owned expenses and viewer visibility rows", async () => {
    ...
    await t.run(async (ctx) => {
      await ctx.db.insert("expenses", {
        ...
        participants: [
          { member_id: "viewer_member", name: "Viewer", linked_account_email: "viewer@example.com" },
    ...
    expect(expenses.find((expense) => expense.id === "expense_shared_owned_by_owner")).toBeDefined();
